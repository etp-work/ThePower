...
public class PropertiesHandlerTest {
    ...
    @Test
    public void testGet() {
        Assert.assertEquals("E:\\Study\\portal-team", handler.get(SettingsCommand.PORTAL_TEAM_PATH));
    }
    ...
    public void testSet() {
        String test = "testing";
        handler.set(SettingsCommand.PORTAL_TEAM_PATH, test);
        handler.write();
        handler.read();
        Assert.assertEquals(test, handler.get(SettingsCommand.PORTAL_TEAM_PATH));
    }
    ...
    public void testFromBean() {
        ...
        Assert.assertEquals("C:\\Users\\ehaozuo\\designenv\\apache-tomcat-7.0.30\\webapps",
                handler.get(SettingsCommand.TOMCAT_WEBAPPS_PATH));
    }
    ...
    public void testToBean() {
        SettingsCommand set1 = new SettingsCommand();
        ...
        handler.write();
        SettingsCommand set2 = new SettingsCommand();
        handler.toBean(set2);
    ...
    private void resetConfiguration() {
        handler.set(SettingsCommand.PORTAL_TEAM_PATH, "E:\\Study\\portal-team");
        handler.write();
    }
}
