...
public class MavenExecutor {
	...
	/**
	 * Execute the specified command type to the project which indicated by
	 * <code>path</code>.
	 * 
	 * @param path
	 *            the project defined by this path will be executed.
	 * @param type
	 *            executed command type. <code>ExecuteType.COMPILE</code>,
	 ...
	 * 
	 * @param path
	 *            a folder path which should contains a pom.xml
